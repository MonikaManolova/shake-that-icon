  ...
  >
    ...
    {props.is_animated ? (
      <style>
        ...
        #eS8rsT0NJIw1${props.event} #eS8rsT0NJIw3 {
          animation-name: eS8rsT0NJIw3__m;
        ...
        #eS8rsT0NJIw1${props.event} #eS8rsT0NJIw3_to {
          animation-name: eS8rsT0NJIw3_to__to;
          animation-duration: ${props.speed || "1.000"}s;
          animation-fill-mode: forwards;
          animation-timing-function: linear;
          animation-direction: normal;
